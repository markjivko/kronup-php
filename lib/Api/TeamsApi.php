...
class TeamsApi extends AbstractApi {
     ...
     */
    public function listAll($page_number = 1, $page_size = 500) {
        ...
        if (isset($page_size) && $page_size > 1500) {
            throw new IAE('Invalid value for "$page_size" when calling TeamsApi., must be smaller than or equal to 1500');
        }
     ...
     */
    public function listUser($user_id, $page_number = 1, $page_size = 500) {
        if (isset($page_number) && $page_number < 1) {
            throw new IAE('Invalid value for "$page_number" when calling TeamsApi., must be bigger than or equal to 1.');
        }
