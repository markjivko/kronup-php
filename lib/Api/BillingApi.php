...
class BillingApi extends AbstractApi {
     ...
     */
    public function invoiceList($page_number = 1, $page_size = 100) {
        ...
        if (isset($page_size) && $page_size > 500) {
            throw new IAE('Invalid value for "$page_size" when calling BillingApi., must be smaller than or equal to 500');
        }
