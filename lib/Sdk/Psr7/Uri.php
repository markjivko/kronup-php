...
use Kronup\Sdk\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable {
     ...
     * `Kronup\Sdk\Psr7\Http\UriInterface::__toString`.
     *
     ...
     *
     * `Kronup\Sdk\Psr7\Http\UriInterface::getPort` may return null or the standard port. This method can be used
