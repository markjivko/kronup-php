...
class Error404 extends AbstractModel {
    ...
    /**
     * Get id - Unique lowercase string that identifies this 404 error
     *
     * @return string
     */
    ...
    /**
     * Set id - Unique lowercase string that identifies this 404 error
     * 
    ...
    /**
     * Set message - 404 Error message
     * 
     * @param string $message 404 Error message
     * @throws \InvalidArgumentException
     * @return $this
     */
