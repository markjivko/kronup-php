 ...
 * 
 * @link    https://kronup.github.io/kronup-php/Api/TasksApi/#taskdiscoverycreate
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->tasks()->taskDiscoveryCreate(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->tasks()->taskDiscoveryCreate(): %s\n", 
        $exc->getMessage()
    );
}