 ...
 * 
 * @link    https://kronup.github.io/kronup-php/Api/TasksApi/#discoveryupdate
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->tasks()->discoveryUpdate(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->tasks()->discoveryUpdate(): %s\n", 
        $exc->getMessage()
    );
}