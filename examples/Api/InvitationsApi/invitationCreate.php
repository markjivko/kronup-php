 ...
 * 
 * @link    https://kronup.github.io/kronup-php/Api/InvitationsApi/#invitationcreate
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->invitations()->invitationCreate(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->invitations()->invitationCreate(): %s\n", 
        $exc->getMessage()
    );
}