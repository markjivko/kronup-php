 ...
 * 
 * @link    https://kronup.github.io/kronup-php/Api/AssumptionsApi/#read
 * @license MIT
 * @author  Mark Jivko
 * 
 * SECURITY WARNING
...
try {
    ...
    echo sprintf(
        "API Exception when calling api()->assumptions()->read(): %s\n", 
        var_export($apiExc->getResponseObject(), true)
    );
} catch (\Exception $exc) {
    echo sprintf(
        "Exception when calling api()->assumptions()->read(): %s\n", 
        $exc->getMessage()
    );
}